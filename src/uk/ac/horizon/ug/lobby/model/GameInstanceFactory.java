...
public class GameInstanceFactory {
    ...
    //@Lob
    private Text/*String*/ startTimeOptionsJson;
	...
	@Persistent     
	@Embedded(members = {         
			@Persistent(name="value", columns=@Column(name="newInstanceCounterValue")),
			@Persistent(name="startTime", columns=@Column(name="newInstanceCounterStartTime")),
			@Persistent(name="updateTime", columns=@Column(name="newInstanceCounterUpdateTime"))
	}) 	
	...
	public String getStartTimeOptionsJson() {
		return startTimeOptionsJson.toString();
	}
	/**
	...
	public void setStartTimeOptionsJson(String startTimeOptionsJson) {
		this.startTimeOptionsJson = new Text(startTimeOptionsJson);
	}
	/**
	 * @return the type
	 */
